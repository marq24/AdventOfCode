...
public class D03 {
    ...
    public static void v2(String[] lines) {
        ...
        for(String aLine:lines){
            ...
            while(m.find(last)){
                ...
                if(aGearPosition != null){
                    ArrayList<Integer> otherGearsAtSamePosition = gearsAtPosition.get(aGearPosition);
                    if(otherGearsAtSamePosition == null){
                        otherGearsAtSamePosition = new ArrayList<>();
                        gearsAtPosition.put(aGearPosition, otherGearsAtSamePosition);
                    }
                    otherGearsAtSamePosition.add(Integer.parseInt(m.group()));
                }
        ...
        long sum = 0;
        for(ArrayList<Integer> aPossibleGearTuple: gearsAtPosition.values()){
            if(aPossibleGearTuple.size() > 1){
